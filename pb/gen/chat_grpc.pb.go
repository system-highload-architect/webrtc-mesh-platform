...
const (
	...
	ChatHistoryBridge_GetRoomChatHistory_FullMethodName  = "/pb.ChatHistoryBridge/GetRoomChatHistory"
)
...
type ChatHistoryBridgeClient interface {
	...
	GetRoomChatHistory(ctx context.Context, in *GetHistoryRequest, opts ...grpc.CallOption) (*GetHistoryResponse, error)
}
...
func (c *chatHistoryBridgeClient) GetRoomChatHistory(ctx context.Context, in *GetHistoryRequest, opts ...grpc.CallOption) (*GetHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetHistoryResponse)
	err := c.cc.Invoke(ctx, ChatHistoryBridge_GetRoomChatHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatHistoryBridgeServer interface {
	...
	// НОВЫЙ ФУНКЦИОНАЛ ТЗ: Метод выгрузки архива сообщений по запросу шлюза
	GetRoomChatHistory(context.Context, *GetHistoryRequest) (*GetHistoryResponse, error)
...
func (UnimplementedChatHistoryBridgeServer) GetRoomChatHistory(context.Context, *GetHistoryRequest) (*GetHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRoomChatHistory not implemented")
}
...
func _ChatHistoryBridge_GetRoomChatHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatHistoryBridgeServer).GetRoomChatHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatHistoryBridge_GetRoomChatHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatHistoryBridgeServer).GetRoomChatHistory(ctx, req.(*GetHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatHistoryBridge_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRoomChatHistory",
			Handler:    _ChatHistoryBridge_GetRoomChatHistory_Handler,
		},
	},
